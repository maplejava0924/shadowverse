...
public class EmeraldaDemonicOfficer extends Follower {

	public EmeraldaDemonicOfficer() {
		name = "デモンオフィサー・エメラダ";
		rank = "vampire";
		ap = 4;
		hp = 5;
	...
	public void fanfare(Leader turnLeader, Leader noTurnLeader, int choiceNumber) {
		...
		if (choiceNumber != 99) {
			noTurnLeader.getFieldList()[choiceNumber].die(noTurnLeader, turnLeader, choiceNumber); // 相手のフォロワーまたはアミュレットを破壊
		}
